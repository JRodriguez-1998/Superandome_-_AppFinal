...
public class multimedia_video_director extends Fragment {
    VideoView videoView;
    MediaController mediaController;
    InputStream inputStream;
    int idContenido;
    public multimedia_video_director() {
    }
...
//            videoView.start();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_multimedia_video_director, container, false);
    }
}
