...
public class dialogoErrorInesperado extends DialogFragment {
    Activity actividad;
    TextView txtEstatus, txtMensaje, btnAceptar;

    public dialogoErrorInesperado() {
    }
    ...
    private AlertDialog crearDialogo(){
        ...
        View v = inflater.inflate(R.layout.fragment_dialogo_errorinesperado,null);
        builder.setView(v);
