...
public class dialogoSugerirContenidoProf extends DialogFragment {

    Activity actividad;
    TextView txtEstatus, txtMensaje, btnAceptar;

    public dialogoSugerirContenidoProf() {}
    ...
    private AlertDialog crearDialogo(){
        ...
        View v = inflater.inflate(R.layout.fragment_dialogo_sugerir_contenido_prof,null);
        builder.setView(v);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dialogo_sugerir_contenido_prof, container, false);
    }
}