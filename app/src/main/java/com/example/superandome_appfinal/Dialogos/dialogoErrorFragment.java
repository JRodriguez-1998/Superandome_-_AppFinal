...
public class dialogoErrorFragment extends DialogFragment {
    Activity actividad;
    TextView txtEstatus, txtMensaje, btnAceptar;

    public dialogoErrorFragment() {
    }
    ...
    private AlertDialog crearDialogo(){
        ...
        View v = inflater.inflate(R.layout.fragment_dialogo_errorfragment,null);
        builder.setView(v);
