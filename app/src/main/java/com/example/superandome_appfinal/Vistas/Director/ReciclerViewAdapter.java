...
public class ReciclerViewAdapter extends RecyclerView.Adapter<ReciclerViewAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public ReciclerViewAdapter(List<Contenido> contenidoLista){
        this.contenidoLista = contenidoLista;
    }

    @Override
    public ReciclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_contenido,parent,false);
        ReciclerViewAdapter.ViewHolder vH = new ReciclerViewAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(ReciclerViewAdapter.ViewHolder holder, int position) {
