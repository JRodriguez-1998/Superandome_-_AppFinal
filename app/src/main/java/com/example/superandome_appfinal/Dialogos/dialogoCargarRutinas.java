...
public class dialogoCargarRutinas extends DialogFragment {
    Activity actividad;
    TextView txtEstatus, txtMensaje, btnAceptar;

    public dialogoCargarRutinas() {
    }
    ...
    private AlertDialog crearDialogo(){
        ...
        View v = inflater.inflate(R.layout.fragment_dialogo_cargar_rutinas,null);
        builder.setView(v);
